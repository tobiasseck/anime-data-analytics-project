...
# Get the list of entries to scrape (uid and link)
entries = [(row['uid'], row['link']) for _, row in animes_df.iterrows()]
...
scraped_data.to_csv('./data/scraped_anime_data_first_200.csv', index=False)

print("Scraping completed and data saved to scraped_anime_data_first_200.csv")
